...
```
## Use those tables to calculate the marginal & conditional probabilities (see lectures week 3). Then do a hypothesis test to see if those probabilities are the same (spoiler: they aren't). Example, 3/11 and 8/11 vs 1.5/35.5 and 34/35.5 , horizontal marginals. Also try vertical.
